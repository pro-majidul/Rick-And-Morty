...
//                     {characters.map((character, idx) => <div className="relative md:w-56">
//                         {/* Clipped Card Container */}
//                         <div key={idx.id} className="p-[1px] rounded-xl bg-gradient-to-l from-[rgba(132,247,41,0.7)] to-[rgba(21,191,253,0.7)] clip-card">
            ...
            <div className='container mx-auto p-2 relative py-10'>
                ...
                <div className='grid lg:grid-cols-5 md:grid-cols-3 grid-cols-2 gap-5 my-5 py-5'>
                    {characters.map((character) => (
                        <div key={character.id} className="relative md:w-56">
